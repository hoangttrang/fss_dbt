...
-- Calculates maximum hourly pay rate per employee per week. Some employees may be paid multiple times in a single week. In such cases, we take the MAX(hourly_pay_rate) to capture the highest rate.
